...
# Timestamp: 2019-10-21 20:23:40 UTC
# 
...
RUN bash -c 'curl -sL https://deb.nodesource.com/setup_12.x | bash - && apt-get install -y nodejs && apt-get install -y npm'
...
ENV FSLDIR="/usr/share/fsl/5.0" \
    ...
    PATH="/usr/lib/fsl/5.0:/Users/peerherholz/anaconda3/bin:/Users/peerherholz/anaconda3/condabin:/Users/peerherholz/abin:/usr/local/antsbin/bin:/Applications/MATLAB_R2014a.app/bin:/Applications/freesurfer/bin:/Applications/freesurfer/fsfast/bin:/Applications/freesurfer/tktools:/usr/local/fsl/bin:/Applications/freesurfer/mni/bin:/usr/local/fsl/bin:/Users/peerherholz/anaconda3/bin:/usr/bin:/bin:/usr/sbin:/sbin:/usr/local/bin:/Applications/workbench/bin_macosx64:/usr/local/texlive/2019/bin/x86_64-darwin"
...
RUN echo '{ \
    ...
    \n    [ \
    \n      "run_bash", \
    \n      "curl -sL https://deb.nodesource.com/setup_12.x | bash - && apt-get install -y nodejs && apt-get install -y npm" \
    \n    ], \
    \n    [ \
    \n      "add_to_entrypoint", \
